...
<div id="footer" class="ui grid centered segment inverted">
	<div  class="one column center aligned ">
		<div><p>
			...
			<a href="<s:url value="/shop/signup"/>" class="ui item"><s:text name="global.main_menu_register" /></a> |
			<a href="<s:url value="/shop/login"/>" class="ui item"><s:text name="global.main_menu_login" /></a>
		</p></div>
