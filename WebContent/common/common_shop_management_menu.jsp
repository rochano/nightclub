<%@ taglib prefix="s" uri="/struts-tags" %>
	...
	<a class="item <s:if test="%{menu.equalsIgnoreCase('reserve')}">active</s:if>" href="<s:url value="/management/reserve"/>"><i class="calendar icon"></i><s:text name="global.menu_reserve" /></a>
