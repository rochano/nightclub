...
<div class="ui fixed top menu">
	...
	<div class="right menu">
		<div class="ui dropdown item">
			...
			<div class="menu">
				<div class="item">
					<a class="ui tiny" href="<s:url value="/management_en_girl/howtoinput"/>"><i class="file outline icon"></i><s:text name="global.how_to_input" /></a>
				</div>
				<div class="item">
					<a class="ui tiny" href="<s:url value="/management_en_girl/changepassword"/>"><i class="edit icon"></i><s:text name="global.change_password" /></a>
				</div>
				<div class="item">
