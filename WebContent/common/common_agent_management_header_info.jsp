...
<div class="ui fixed top menu">
	...
	<div class="right menu">
		<div class="ui dropdown item">
			...
			<div class="menu">
				<div class="item">
					<a class="ui tiny" href="<s:url value="/management_agent/howtoinput"/>"><i class="file outline icon"></i><s:i18n name="global_th"><s:text name="global.how_to_input" /></s:i18n></a>
				</div>
				<div class="item">
					<a class="ui tiny" href="<s:url value="/management_agent/changepassword"/>"><i class="edit icon"></i><s:i18n name="global_th"><s:text name="global.change_password" /></s:i18n></a>
				</div>
				<div class="item">
