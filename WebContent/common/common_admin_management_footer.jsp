...
<div id="footer" class="ui grid centered segment inverted">
	<div  class="one column center aligned ">
		<div><p>
			...
			<a href="<s:url value="/admin/girlsetting"/>"><span><s:i18n name="global_th"><s:text name="global.menu_girl_setting" /></s:i18n></span></a> |
			<a href="<s:url value="/admin/howtouse"/>"><span><s:i18n name="global_th"><s:text name="global.menu_how_to_use" /></s:i18n></span></a> |
			<a href="<s:url value="/admin/contact"/>"><span><s:i18n name="global_th"><s:text name="global.menu_contact" /></s:i18n></span></a> |
			<a href="<s:url value="/admin/skin"/>"><span><s:i18n name="global_th"><s:text name="global.skin" /></s:i18n></span></a> |
