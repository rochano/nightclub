...
<%@include file="/common/common_independent_management_header_info.jsp" %>
<!-- Sidebar Menu -->
<div class="ui toc vertical top large inverted sidebar menu">
	...
	<%@include file="/common/common_independent_management_menu.jsp" %>
</div>
<div class="pusher">
...
<div class="ui segment very basic container">
			...
			<div class="ui accordion">
				...
				<div class="ui centered attached segment active content">
					<form class="ui form " method="post" action="<s:url value="/management_independent/information/update"/>" enctype="multipart/form-data" >
  	...
  	<%@include file="/common/common_independent_management_footer.jsp" %>  
</div>
</div>
<script type="text/javascript">
