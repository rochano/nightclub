...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  $(document)
    ...
    ;
	  ...
	  $('#scheduleSearch_startTime, #scheduleSearch_endTime').timeEntry({show24Hours: true});
	  $('#scheduleInfo_startTime, #scheduleInfo_endTime').timeEntry({show24Hours: true});
    })
  ;
  </script>
</head>
			...
			<div class="ui search selection dropdown">
				...
				<div class="menu">
					...
					<div class="item" data-value='<s:property value="girlInfoId" />'>
						<img class="ui mini avatar image" src="<s:property value="pic1" />">
