...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title><s:i18n name="global_th"><s:text name="global.management" /><s:text name="global.administrator" /> - <s:text name="global.description" /></s:i18n></title>
			...
			<div class="ui accordion">
				...
				<div class="ui centered grid attached segment active content">
					<div class="column one left aligned">
						<form class="ui form " method="post" action="<s:url value="/admin/description/update"/>" >
							...
							<div class="inline field">
								<s:textarea name="homeInfo.descriptionShopService" />
								<script type="text/javascript">
									CKEDITOR.replace("homeInfo.descriptionShopService", {
							...
							<div class="inline field">
								<s:textarea name="homeInfo.descriptionAgent" />
								<script type="text/javascript">
									CKEDITOR.replace("homeInfo.descriptionAgent", {
										/*filebrowserBrowseUrl : '${pageContext.request.contextPath }/ckfinder/ckfinder.html',
										filebrowserImageBrowseUrl : '${pageContext.request.contextPath }/ckfinder/ckfinder.html?type=Images',
										filebrowserFlashBrowseUrl : '${pageContext.request.contextPath }/ckfinder/ckfinder.html?type=Flash',*/
										filebrowserUploadUrl : '${pageContext.request.contextPath }/ckfinder/core/connector/java/connector.java?command=QuickUpload&type=Files'/*,
							...
							<div class="inline field">
								<s:textarea name="homeInfo.descriptionFreeAgent" />
								<script type="text/javascript">
									CKEDITOR.replace("homeInfo.descriptionFreeAgent", {
										/*filebrowserBrowseUrl : '${pageContext.request.contextPath }/ckfinder/ckfinder.html',
										filebrowserImageBrowseUrl : '${pageContext.request.contextPath }/ckfinder/ckfinder.html?type=Images',
										filebrowserFlashBrowseUrl : '${pageContext.request.contextPath }/ckfinder/ckfinder.html?type=Flash',*/
										filebrowserUploadUrl : '${pageContext.request.contextPath }/ckfinder/core/connector/java/connector.java?command=QuickUpload&type=Files'/*,
							...
							<div class="inline field">
								<s:textarea name="homeInfo.descriptionEnGirl" />
								<script type="text/javascript">
									CKEDITOR.replace("homeInfo.descriptionEnGirl", {
										/*filebrowserBrowseUrl : '${pageContext.request.contextPath }/ckfinder/ckfinder.html',
										filebrowserImageBrowseUrl : '${pageContext.request.contextPath }/ckfinder/ckfinder.html?type=Images',
										filebrowserFlashBrowseUrl : '${pageContext.request.contextPath }/ckfinder/ckfinder.html?type=Flash',*/
										filebrowserUploadUrl : '${pageContext.request.contextPath }/ckfinder/core/connector/java/connector.java?command=QuickUpload&type=Files'/*,
