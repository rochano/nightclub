    ...
    ;
	  ...
	  $("#editmultiplebtn")
		.on('click', function() {
		  ...
		  $('.ui.modal.edit .header:first').text("<s:i18n name="global_th"><s:text name="global.edit_information" /><s:text name="global.menu_en_girl" /></s:i18n>(" + selectedItem + " รายการ)");
	  ...
	  $("#deletemultiplebtn")
		.on('click', function() {
		  ...
		  $('.ui.modal.delete .header:first').text("<s:i18n name="global_th"><s:text name="global.delete_information" /><s:text name="global.menu_en_girl" /></s:i18n>(" + selectedItem + " รายการ)");
		  $('.ui.modal.delete')
			    .modal('show')
			  ;
	    });
...
<div class="ui modal delete">
  <i class="close icon"></i>
  <div class="header">
    <s:i18n name="global_th"><s:text name="global.delete_information" /><s:text name="global.menu_en_girl" /></s:i18n>
  </div>
  <div class="content centered">
    <form class="ui form" id="deleteForm" method="post" action="<s:url value="/admin/engirl/multipledelete"/>" >
