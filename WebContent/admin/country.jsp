...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title><s:text name="global.management" /><s:text name="global.administrator" /> - <s:i18n name="global_th"><s:text name="global.country" /></s:i18n></title>
  ...
  $(document)
    ...
    ;
      $("#addbtn")
		.on('click', function() {
		  $('.ui.modal .header:first').text("<s:text name="global.add_information" /><s:i18n name="global_th"><s:text name="global.country" /></s:i18n>");
...
<div class="ui segment very basic container">
			...
			<div class="ui accordion">
				...
				<div class="ui left aligned attached segment active content">
					<form class="ui form" id="searchForm" method="post" action="<s:url value="/admin/country/search"/>">
						<div class="inline field">
							<s:textfield name="countrySearch.countryNameJp" key="global.japanese_name"/>
						</div>
						<div class="inline field">
							<s:textfield name="countrySearch.countryNameEn" key="global.english_name"/>
						</div>
				...
				<h4 class="ui top attached header inverted active title">
					<i class="dropdown icon"></i>
					<s:i18n name="global_th"><s:text name="global.country" /></s:i18n>
				</h4>
				<div class="ui centered grid attached segment active content">
					<div class="column one left aligned">
						...
						<table id="searchList" class="ui table celled compact striped unstackable sortable">
							...
							<tbody>
								<s:iterator value="countryInfos" status="status">
								<tr>
									<td class="center aligned"><s:property value="#status.count" /></td>
									<td><s:property value="countryNameJp" /></td>
									<td><s:property value="countryNameEn" /></td>
...
<div class="ui modal">
  <i class="close icon"></i>
  <div class="header">
    <s:text name="global.edit_information" /><s:i18n name="global_th"><s:text name="global.country" /></s:i18n>
  </div>
  <div class="content">
    <form class="ui form" id="infoForm" method="post" action="<s:url value="/admin/country/update"/>">
		<div class="inline field">
			<s:textfield name="countryInfo.countryNameJp" key="global.japanese_name" />
		</div>
		<div class="inline field">
			<s:textfield name="countryInfo.countryNameEn" key="global.english_name" />
		</div>
		<s:hidden name="action" value="update"></s:hidden>
		<s:hidden name="countryInfo.countryInfoId"></s:hidden>
