...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title><s:i18n name="global_th"><s:text name="global.management" /><s:text name="global.administrator" /> - <s:text name="global.country" /></s:i18n></title>
			...
			<div class="ui accordion">
				...
				<div class="ui left aligned attached segment active content">
					<form class="ui form" id="searchForm" method="post" action="<s:url value="/admin/country/search"/>">
						...
						<div class="inline field">
							<s:i18n name="global_th"><s:textfield name="countrySearch.countryNameEn" key="global.english_name"/></s:i18n>
						</div>
...
<div class="ui modal">
  ...
  <div class="content">
    <form class="ui form" id="infoForm" method="post" action="<s:url value="/admin/country/update"/>">
		...
		<div class="inline field">
			<s:i18n name="global_th"><s:textfield name="countryInfo.countryNameEn" key="global.english_name" /></s:i18n>
		</div>
