...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title><s:text name="global.management" /><s:text name="global.administrator" /> - <s:i18n name="global_th"><s:text name="global.gender" /></s:i18n></title>
  ...
  $(document)
    ...
    ;
      $("#addbtn")
		.on('click', function() {
		  $('.ui.modal .header:first').text("<s:text name="global.add_information" /><s:i18n name="global_th"><s:text name="global.gender" /></s:i18n>");
				...
				<div class="ui left aligned attached segment active content">
					<form class="ui form" id="searchForm" method="post" action="<s:url value="/admin/gender/search"/>">
						<div class="inline field">
							<s:textfield name="genderSearch.genderNameJp" key="global.japanese_name"/>
						</div>
						<div class="inline field">
							<s:textfield name="genderSearch.genderNameEn" key="global.english_name"/>
						</div>
...
<div class="ui modal">
  <i class="close icon"></i>
  <div class="header">
    <s:text name="global.edit_information" /><s:i18n name="global_th"><s:text name="global.gender" /></s:i18n>
  </div>
  <div class="content">
    <form class="ui form" id="infoForm" method="post" action="<s:url value="/admin/gender/update"/>">
		<div class="inline field">
			<s:textfield name="genderInfo.genderNameJp" key="global.japanese_name" />
		</div>
		<div class="inline field">
			<s:textfield name="genderInfo.genderNameEn" key="global.english_name" />
		</div>
