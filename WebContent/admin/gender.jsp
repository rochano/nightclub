...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title><s:i18n name="global_th"><s:text name="global.management" /><s:text name="global.administrator" /> - <s:text name="global.gender" /></s:i18n></title>
  ...
  $(document)
    ...
    ;
      $("#addbtn")
		.on('click', function() {
		  $('.ui.modal .header:first').text("<s:i18n name="global_th"><s:text name="global.add_information" /><s:text name="global.gender" /></s:i18n>");
		  $('#infoForm').find("input[type=text], input[type=hidden], textarea").val("");
		  $('#infoForm')[0].action.value = "add";
		  $('#infoForm')[0].action = "<s:url value="/admin/gender/add"/>";
        $('.ui.modal')
		    .modal('show')
		  ;
      });
...
<div class="ui segment very basic container">
			...
			<div class="ui accordion">
				...
				<div class="ui left aligned attached segment active content">
					<form class="ui form" id="searchForm" method="post" action="<s:url value="/admin/gender/search"/>">
						<div class="inline field">
							<s:i18n name="global_th"><s:textfield name="genderSearch.genderNameJp" key="global.japanese_name"/></s:i18n>
						</div>
						<div class="inline field">
							<s:i18n name="global_th"><s:textfield name="genderSearch.genderNameEn" key="global.english_name"/></s:i18n>
						</div>
				...
				<h4 class="ui top attached header inverted active title">
					<i class="dropdown icon"></i>
					<s:i18n name="global_th"><s:text name="global.gender" /></s:i18n>
				</h4>
				<div class="ui centered grid attached segment active content">
					<div class="column one left aligned">
						...
						<table id="searchList" class="ui table celled compact striped unstackable sortable">
							...
							<tbody>
								<s:iterator value="genderInfos" status="status">
								<tr>
									<td class="center aligned"><s:property value="#status.count" /></td>
									<td><s:property value="genderNameJp" /></td>
									<td><s:property value="genderNameEn" /></td>
...
<div class="ui modal">
  <i class="close icon"></i>
  <div class="header">
    <s:i18n name="global_th"><s:text name="global.edit_information" /><s:text name="global.gender" /></s:i18n>
  </div>
  <div class="content">
    <form class="ui form" id="infoForm" method="post" action="<s:url value="/admin/gender/update"/>">
		<div class="inline field">
			<s:i18n name="global_th"><s:textfield name="genderInfo.genderNameJp" key="global.japanese_name" /></s:i18n>
		</div>
		<div class="inline field">
