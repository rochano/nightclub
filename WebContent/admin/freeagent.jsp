...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title><s:text name="global.management" /><s:text name="global.administrator" /> - <s:text name="global.menu_free_agent" /></title>
    ...
    ;
	  ...
	  $("#editmultiplebtn")
		.on('click', function() {
		  ...
		  $('.ui.modal .header:first').text("<s:text name="global.edit_information" /><s:text name="global.menu_free_agent" />(" + selectedItem + " รายการ)");
...
<div class="ui modal">
  <i class="close icon"></i>
  <div class="header">
    <s:text name="global.edit_information" /><s:text name="global.menu_free_agent" />
  </div>
  <div class="content">
