...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title><s:i18n name="global_th"><s:text name="global.management" /><s:text name="global.administrator" /> - <s:text name="global.menu_client" /></s:i18n></title>
    ...
    ;
	  ...
	  $("#editmultiplebtn")
		.on('click', function() {
		  ...
		  $('.ui.modal.edit .header:first').text("<s:i18n name="global_th"><s:text name="global.edit_information" /><s:text name="global.menu_client" /></s:i18n>(" + selectedItem + " รายการ)");
	  ...
	  $("#deletemultiplebtn")
		.on('click', function() {
		  ...
		  $('.ui.modal.delete .header:first').text("<s:i18n name="global_th"><s:text name="global.delete_information" /><s:text name="global.menu_client" /></s:i18n>(" + selectedItem + " รายการ)");
		  $('.ui.modal.delete')
			    .modal('show')
			  ;
	    });
...
<div class="ui segment very basic container">
			...
			<s:if test="hasActionMessages()">
				...
				<h4 class="ui top attached header inverted active title">
					<i class="dropdown icon"></i>
					<s:i18n name="global_th"><s:text name="global.menu_client" /></s:i18n>
				</h4>
						...
						<table id="searchList" class="ui table celled compact striped unstackable sortable">
							<thead class="center aligned">
								<tr>
									...
									<th><s:i18n name="global_th"><s:text name="global.email" /></s:i18n></th>
									<th><s:i18n name="global_th"><s:text name="global.mobile" /></s:i18n></th>
...
<div class="ui modal edit">
  <i class="close icon"></i>
  <div class="header">
    <s:i18n name="global_th"><s:text name="global.edit_information" /><s:text name="global.menu_client" /></s:i18n>
  </div>
  <div class="content">
    <form class="ui form" id="infoForm" method="post" action="<s:url value="/admin/client/update"/>" >
		...
		<div class="inline field">
			<label><s:i18n name="global_th"><s:text name="global.email" /></s:i18n></label>
			<s:textfield name="userInfo.clientInfo.email" disabled="true"/>
		</div>
		<div class="inline field">
			<label><s:i18n name="global_th"><s:text name="global.mobile" /></s:i18n></label>
...
<div class="ui modal delete">
  <i class="close icon"></i>
  <div class="header">
    <s:i18n name="global_th"><s:text name="global.delete_information" /><s:text name="global.menu_client" /></s:i18n>
  </div>
  <div class="content centered">
    <form class="ui form" id="deleteForm" method="post" action="<s:url value="/admin/client/multipledelete"/>" >
